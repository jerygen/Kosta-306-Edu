...
public class FreeBoardController {
    ...
    public void list(  Model model ){
        ...
        System.out.println("******************************");
        model.addAttribute("freeList", freeList); //실행해보면 쿼리 하나만 날라감
        //model.addAttribute("freeList", freeBoardDTOList); //뷰에서 ${freeList},
        //reply조회 조인을 안 하고 reply를 필요하게 하니깐 reply를 꺼내오려고 하니깐 게시물만큼 조회 - 지연로딩에서 N+1 문제 발생할 수 있다. => 다른 쿼리문을 사용해서 해결할 수 있다.
   ...
   //////////////////////////////////////////////////////////////////////////////////////
        ...
        model.addAttribute("startPage", startPage); //뷰에서 ${requestScope.startPage}
        ...
        model.addAttribute("pageList", pageList); //Entity
        model.addAttribute("freeList", freeBoardDTOList); //DTO
   ...
   // public String insert(FreeBoard freeBoard){//entity 전달
    ...
    public String read(@PathVariable String bno, Model model, String flag){
        ...
        boolean state = flag == null; //null 일 때 true

...
class UsingMethodExam{
	...
	인수로 받은 정수 출력 
	정수*2 리턴. */
	private int methodExam03_01(int n) {
	...
	*/	
	public String methodExam03_02(String str, int n) {
		...
		System.out.println(methodExam03_01(n));
	...
	*/	
	protected double methodExam03_04(int a, double b, int c) {
		...
		return mme.methodExam02_04(a, b, c);
	}
...
class UsingMethod{
	...
	public static void main(String[] args) {
		...
		System.out.println(ume.methodExam03_02("메롱", 5));
		ume.methodExam03_03(2, "안녕");
		System.out.println(ume.methodExam03_04(4, 3, 2));
	}

...
function App() {
  const {fruit, setFruit} =use(FruitsContext);
  ...
  <div className="row">
    ...
    <div className="col-md-6" style={{textAlign:"right"}}>
      ...
      <select   
        ...
        {/* 상품 목록 출력하는  Container */}
        {/* <div className="container" style={{marginTop:'30px'}} >
        <div className="row">
          {
              fruit.map((ele)=>{
                return(
                  <Product fruit={ele}   key={ele.id} />
                )
              })
          }
     </div>
     ...
     <div className="container" style={{ marginTop: "30px" }}>
                  <div className="row">
                    ...
                    fruit
                      ...
                      .map((ele) => (
                        <Product fruit={ele} key={ele.id} /> // 필터링된 항목 출력
                      ))}
                  </div>
</div>
    ...
    <div className="container">
       <div className="row">
             <div style={{ textAlign: "center" }}>
                 ...
                 if(count==1){
                   axios.get('https://8253jang.github.io/react-data/veggie2.json').then((result)=>{
                       let copy10 =[...veggie, ...result.data];
                       setVeggie(copy10);
                       setCount(count + 1);
              
                 })}else if(count==2){
                   axios.get('https://8253jang.github.io/react-data/veggie3.json').then((result)=>{

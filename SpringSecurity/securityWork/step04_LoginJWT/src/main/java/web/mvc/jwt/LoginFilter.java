...
public class LoginFilter extends UsernamePasswordAuthenticationFilter{ //폼값 받는 컨트롤러 역할의 필터
	...
	private final JWTUtil jwtUtil; //토큰 만들 때 사용하는 객체
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
        ...
        //1. 클라이언트 로그인 요청시 id, password 받아서 출력 - username, password로 정해져 있음
        //request.getParameter와는 다른 것
    ...
    protected void successfulAuthentication(HttpServletRequest request,
        ...
        */
        ...
        //응답할 헤더를 설정
        //베어러 뒤에 공백을 준다. 관례적인 prefix(인증에 관한 토큰이라는 표시를 위해 붙임)
